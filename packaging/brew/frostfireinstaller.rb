class Frostfireinstaller < Formula
  ...
  homepage "https://github.com/OWNER/frostfireinstaller"
  url "https://github.com/OWNER/frostfireinstaller/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "REPLACE_WITH_TARBALL_SHA256"
  license "MIT"
  head "https://github.com/OWNER/frostfireinstaller.git", branch: "main"
